...
- Conflict: A sustained dispute or friction between parties.
  Required: name, scale (micro/meso/macro/meta),
  domain (interpersonal/workplace/commercial/legal/political/armed),
  status (latent/active/dormant/resolved/transformed)
  Optional: glasl_stage (1-9), summary

- Event: A discrete time-bounded occurrence.
  Required: event_type (agree/consult/support/cooperate/aid/yield/
  demand/disapprove/reject/threaten/protest/assault/fight/seize/
  sanction/reduce_relations), severity (0-1), occurred_at (ISO datetime)
...
- Process: Any procedure for addressing the conflict.
  Required: process_type (negotiation/mediation/arbitration/adjudication/
  facilitation/conciliation/fact_finding/good_offices/hybrid),
  resolution_approach (interests/rights/power),
  status (pending/active/paused/completed/failed/abandoned)

- Outcome: The result of a resolution process.
  Required: outcome_type (agreement/verdict/award/settlement/
  withdrawal/impasse/transformation)
