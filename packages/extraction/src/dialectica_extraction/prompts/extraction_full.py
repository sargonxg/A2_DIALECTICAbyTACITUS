...
Extract ALL conflict entities from the following text. \
...
- EmotionalState: An actor's emotional condition at a point in time.
  Required: primary_emotion (joy/trust/fear/surprise/sadness/
  disgust/anger/anticipation), intensity (low/medium/high/extreme)
  Optional: secondary_emotion, valence (-1 to 1), arousal (0-1),
  is_group_emotion

- TrustState: Trust level between two actors (Mayer/Davis/Schoorman).
  Required: perceived_ability (0-1), perceived_benevolence (0-1),
  perceived_integrity (0-1), overall_trust (0-1)
  Optional: propensity_to_trust (0-1),
  trust_basis (calculus/knowledge/identification/deterrence/institution)

- PowerDynamic: Power relationship between actors.
  Required: power_domain (coercive/reward/legitimate/expert/
  referent/informational), magnitude (0-1),
