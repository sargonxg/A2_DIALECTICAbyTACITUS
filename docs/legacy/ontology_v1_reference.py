...
This file was the original TACITUS Core Ontology v2.0 definition using plain dicts.
The canonical implementation is now in packages/ontology/ using Pydantic v2 models.
Retained for historical reference only. See packages/ontology/ for the active code.
